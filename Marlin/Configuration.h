...
#define CUSTOM_MACHINE_NAME "Troy's Ender-5"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -3.38 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_INVERTING true      // Should the sensor be triggered on HIGH or LOW? Inverting depends on the sensor.
